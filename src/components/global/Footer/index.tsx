...
function index({ }: Props) {
    return (
        <footer className="footer items-center p-4 px-16 bg-neutral text-neutral-content hidden lg:flex lg:justify-between">
